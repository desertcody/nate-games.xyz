...
if (isAccountSaved) {
  ...
  const GithubSignIn = document.querySelector("#GithubAuth");

  signUpButton.addEventListener("click", function () {
    if (GithubSignIn.style.display === "block") {
  ...
  function SaveSignUp() {
    ...
    if (usernameInput === "nate-games") {
      if (passwordInput === password) {
        ...
        error.textContent =
          "Username cannot be the same as the owner's. Please choose a different username";
